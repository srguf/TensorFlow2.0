...
for i in range(60, len(training_set_scaled)):
    x_train.append(training_set_scaled[i - 60:i, 0])  # 选取60天，第0列
...
model = tf.keras.Sequential([
    SimpleRNN(80, return_sequences=True),  # return_sequences参数控制SimpleRNN层是否返回完整的输出序列或仅返回最后一个时间步的输出。
    Dropout(0.2),
    SimpleRNN(100),
    Dropout(0.2),
    Dense(1)
...
checkpoint_save_path = "../../../data/checkpoint/RNNPredict.ckpt"
...
file = open('../../../data/RNNPredict_weights.txt', 'w')  # 参数提取
